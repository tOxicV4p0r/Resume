    ...
    return (
        <div className="space-y-3">
            ...
            <div className="grid grid-cols-8 gap-y-3">
                ...
                <div className="col-span-2 text-gray-500">linkedin</div>
                <div className="col-span-6">
                    <div>
                        <a className="underline underline-offset-4 after:content-['_↗']" href="https://www.linkedin.com/in/kraisorn-deelert-90a06942/" target="_blank">Kraisorn</a>
                    </div>
                </div>
